...
const Project = ({ title, subtitle, description, technologies, projectUrl, hrefLive, hrefCode }) => {
	return (
		<div className='projects__project'>
			<div className='projects__col projects__col--left'>
				...
				<div className='project__links'>
					...
					{hrefCode && (
						<a className='project__title--text project__link project__link--github' href={hrefCode}>
