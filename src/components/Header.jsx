				...
				<div className='header__top'>
					...
					<div className='header__top-contact header__top-email'>
						...
						<div className='header__top-info'>
							...
							<a href='mailto:kmartynak@icloud.com' className='header__top-value'>
			...
			<div className='header__bottom'>
				<div className='header__bottom-col'>
					<div className='header__left'>
						...
						<p className='header__title header__title-bold header__title-small header__title-light'>an</p>{' '}
						<p className='header__title header__title-'>ambitious </p> <br></br>
						<p className='header__title header__title-bold'>frontend</p> <br></br>
					...
					<div className='header__about'>
						...
						<p className='header__about-me'>
							Hi! Welcome to my little portfolio. My name is Martyna and I am 29 years old. I am from Poland. I speak
							German very well. I am intermediate in English, but I can easily communicate. I have working in the IT
							industry for 4 years... I love doing it! Please check out my projects! There is more on github! You will
							find the link in the upper right corner. I hope you will contact me soon :) Thanks!{' '}
						</p>
					</div>
				</div>
